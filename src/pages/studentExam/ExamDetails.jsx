...
import ProctoringInfo from './ProctoringInfo';
...
const ExamDetails = () => {
    ...
    const handleView = async (id) => {
        if (!user || !examDetails?.examData) return; // Defensive null check
        let activityData = {
    ...
    // If no examDetails or examData are found after fetching
