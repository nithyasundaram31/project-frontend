    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen bg-gradient-to-tr from-blue-300 to-pink-300 px-4'>
            <div className='p-4 mb-16'>
                <h2 className="text-4xl text-center font-bold text-indigo-800">Online Assessment Platform</h2>
            </div>

            <form onSubmit={handleLogin} className='w-96 mb-10 p-6 border-1 bg-white bg-opacity-30 rounded'>
