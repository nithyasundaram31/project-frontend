...
//     // 🔁 Updated function to consider isSubmitted flag
...
//         if (examDateObj.toDateString() === currentDate.toDateString()) {
//             return { status: 'Active', colorClass: 'text-green-500' };
//         } else if (examDateObj < currentDate) {
//             return { status: 'Completed', colorClass: 'text-red-500' };
//         } else {
//             return { status: 'Upcoming', colorClass: 'text-blue-500' };
//         }
//     };
...
//                         <tbody>
//                             {exams && exams.length > 0 ? exams.map((exam, index) => {
//                                 const { status, colorClass } = getExamStatus(exam); // 👈 pass whole exam
//                                 return (
//                                     <tr key={exam._id}>
//                                         <td className="px-4 py-2 border text-center">{index + 1}</td>
//                                         <td className="px-4 py-2 border text-center">{exam.name}</td>
